...
def putta(nod, newvalue):
    ...
    if (
        ...
        # (lämnar oförändrard)
        return nod
    if newvalue < nod.value:  # Om det nya värdet är mindre än det värdet i noden,
        # kallar rekursivt och uppdaterar den nya positionen
        nod.left = putta(nod.left, newvalue)
        return nod
    if newvalue > nod.value:  # Om det nya värdet är större än det värdet i noden,
        # kallar rekursivt och uppdaterar den nya positionen
