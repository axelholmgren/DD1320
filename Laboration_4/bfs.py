...
for ord in rad.split():                                                                                     
    if ord.strip() in svenska and ord.strip() not in gamla:                                             # kollar om det finns i svenska trädet men inte i gamlaträdet                                                                     # Skriver ut ordet
        pass
    ...
    for i in range(3):
        ...
        for j in "abcdefghijklmnopqrstuvwxyzåäö":
            ...
            if ord in svenska and ord not in gamla:
                print(ord)
                gamla.put(ord)                                             # kollar om det finns i svenska trädet men inte i gamlaträdet                                                                     # Skriver ut ordet
