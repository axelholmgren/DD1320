...
with open("/Users/axelholmgren/GitHub/DD1320/Laboration_2/word3.txt", "r", encoding = "utf-8") as svenskfil:        # Läser in filen
    for rad in svenskfil:                                                                                           
        ordet = rad.strip()                                                                                          # Ett trebokstavsord per rad
        svenska.put(ordet)                                                                                           # in i sökträdet

engelska = Bintree()                                                                                                 # Skapar ett tomt träd för engelska ord
with open("/Users/axelholmgren/GitHub/DD1320/Laboration_2/engelska.txt", "r", encoding = "utf-8") as engelskafil:    # Läser in filen
